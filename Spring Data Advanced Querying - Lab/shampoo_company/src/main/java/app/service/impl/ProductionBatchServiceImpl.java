...
public class ProductionBatchServiceImpl implements ProductionBatchService<ProductionBatch, Long> {
    ...
    @Override
    public List<ProductionBatch> findProductionBatchByDateAfter(Date date) {
        return dao.findProductionBatchByBatchDateAfter(date);
    }

    @Override
    public List<ProductionBatch> findBasicIngredientsJoinProductionBatchByShampoosNull() {
        return dao.findBasicIngredientsJoinProductionBatchByShampoosNull();
    }

    @Override
    public List<ProductionBatch> findProductionBatchByBatchDateBefore(Date date) {
        return dao.findProductionBatchByBatchDateBefore(date);
    }
}
